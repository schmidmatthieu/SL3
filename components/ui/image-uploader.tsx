...
import { ImageIcon, Upload, Link as LinkIcon, Plus, Image as ImageLucide } from "lucide-react";
import { MediaManagement } from '@/components/admin/media-management';
import { Label } from '@/components/ui/label';

const DEFAULT_PLACEHOLDER = "https://images.unsplash.com/photo-1505373877841-8d25f7d46678?q=80&w=2000&auto=format&fit=crop";
      ...
      <DialogTrigger asChild>
        <div className={cn('flex items-center gap-6', className)}>
              ...
              <>
                <div className="relative w-full h-full">
                  <Image
                    ...
                    className={cn(
                      "object-cover",
                      !currentImage && "opacity-50 grayscale"
                    )}
                  />
                </div>
          ...
          <div className="flex-1 flex flex-col justify-center space-y-1.5">
            ...
            <p className="text-sm font-medium text-primary-700 dark:text-primary-300">JPG, PNG, GIF, SVG, WebP</p>
      ...
      <DialogContent className="max-w-7xl">
        ...
        <Tabs defaultValue="upload" className="space-y-6">
          <TabsList className="inline-flex h-10 items-center justify-center rounded-lg bg-muted p-1 text-muted-foreground">
            <TabsTrigger value="upload" className="inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
              <Upload className="h-4 w-4 mr-2" />
              Upload
            </TabsTrigger>
            <TabsTrigger value="url" className="inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
              <LinkIcon className="h-4 w-4 mr-2" />
              URL
            </TabsTrigger>
            <TabsTrigger value="media" className="inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">
              ...
              <CardContent className="pt-6 px-6 pb-8">
                <div className="flex flex-col gap-6">
                  <div className="space-y-3">
                    <Label htmlFor="file-upload" className="text-base">Fichier image</Label>
              ...
              <CardContent className="pt-6 px-6 pb-8">
                <div className="flex flex-col gap-6">
                  <div className="space-y-4">
                    <Label htmlFor="image-url" className="text-base">URL de l'image</Label>
