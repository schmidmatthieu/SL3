...
import { mediaService, Media, MediaUsage } from '@/services/api/media';
...
interface MediaStore {
  ...
  updateUsageEntityName: (type: MediaUsage['type'], entityId: string, entityName: string) => Promise<void>;
}
...
export const useMediaStore = create<MediaStore>()(
  devtools(
    (set, get) => ({
      ...
      updateUsageEntityName: async (type: MediaUsage['type'], entityId: string, entityName: string) => {
        set({ isLoading: true, error: null });
        try {
